...
const CadastroProduto = () => {
  ...
  const {dados: produtos, erro, buscarDados} = useGet("http://localhost:3000/api/produto");
  ...
  return (
    <div className="container">
      ...
      <ModalProduto open={open} onClose={() => setOpen(false)} produto={produto} modo={modo} onProdutoCadastrado={buscarDados} />
